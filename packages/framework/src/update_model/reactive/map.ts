// Adapted from: https://github.com/maverick-js/signals/blob/main/src/map.ts

import { compute, createComputation, createScope, dispose, read, scoped, write } from './system';
import type { ComputationNode, Maybe, ReadSignal, Scope } from './types';
  ...
  scoped(() => {
    ...
    // fast path for new create
      ...
      let start: number,
        ...
        tempNodes: ComputationNode[] = new Array(newLen);
